...
import { listProductAction } from "../../../actions/sellerProductAction";
...
export default function ProductList() {
	...
	useEffect(() => {
		...
		if (!adminInfo && !sellerInfo) {
			navigate("/access-denied");
		}
	}, [dispatch, Navigate, adminInfo, sellerInfo]);
											...
											>
											 <td
                                              ...
                                              <td
												...
												>
													<img src={prod.pic} alt="product image" height={70}/>
												</td>
